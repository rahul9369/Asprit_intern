...
const CourseCard = () => {
  return (
    <div className="relative rounded-3xl w-full max-w-4xl mx-auto p-4">
      <div
        className=" bg-cover rounded-3xl bg-center h-96 relative flex"
        style={{
          backgroundImage: "url('/assets/Rectangle 7172img.png')", // Ensure 'car.png' is also in the public folder
        }}>
        <div className="absolute rounded-3xl inset-0 bg-custom-gradient "></div>
